...
assert((6166704) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6166704);
...
HEAPU8.set(new Uint8Array(Module['mem']), GLOBAL_BASE);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6166704;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=923792;function __emscripten_get_fetch_work_queue() {
